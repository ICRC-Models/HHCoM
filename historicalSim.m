...
function historicalSim(calibBool , pIdx , paramsSub , paramSet , paramSetIdx , tstep_abc , date)    % input variables when using a calibration parameter set
...
pathModifier = ['toNow_' , date , '_baseVax057_baseScreen_baseVMMC_fertDec042-076_2020ARTfxd_trackCD4-Discont_discontFxd_DoART_S1_' , num2str(tstep_abc) , '_' , num2str(paramSetIdx)]; % ***SET ME***: name for historical run output file 
...
if ~ isfile([pwd , '/HHCoM_Results/' , pathModifier , '.mat'])
    ...
    propHivDiag = ones(length(s) - 1 , gender) .* propHivDiagBaseline;
...
%       num2str(endYear) ')'])
    ...
    if rem(year , 50) == 0.0
        ...
        save(fullfile(savdir , pathModifier) , 'fivYrAgeGrpsOn' , 'tVec' ,  'popVec' , ...
            'newHiv' , 'transCD4' , ...
            'hivDeaths' , 'deaths' , 'aged1519' , 'ccDeath' , 'menCirc' , ...
            'artDist' , 'artDistList' , 'artTreatTracker' , 'artDiscont' , ...
            'propHivDiag' , 'startYear' , 'endYear' , 'i' , '-v7.3');
    end
...
save(fullfile(savdir , pathModifier) , 'fivYrAgeGrpsOn' , 'tVec' ,  'popVec' , ...
    ...
    'hivDeaths' , 'deaths' , 'aged1519' , 'ccDeath' , 'menCirc' , ...
    'artDist' , 'artDistList' , 'artTreatTracker' , 'artDiscont' , ...
    'propHivDiag' , 'startYear' , 'endYear' , 'i' , 'popLast' , '-v7.3');
