...
pathModifier = ['toNow_' , date , '_noBaseVax_baseScreen_hpvHIVcalib_fertDec04-08_' , num2str(tstep_abc) , '_' , num2str(paramSetIdx)]; % ***SET ME***: name for historical run output file 
