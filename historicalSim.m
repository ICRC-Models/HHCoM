...
pathModifier = ['toNow_' , date , '_noBaseVax_updBaseScreen_hpvHIVcalib_adjFert2_adjCCAgeMults3_KZNCC4_noVMMChpv_' , num2str(tstep_abc) , '_' , num2str(paramSetIdx)]; % ***SET ME***: name for historical run output file 
...
screenAlgorithm = 1; % ***SET ME***: screening algorithm to use (1 for baseline, 3 for spCyto)
