...
for a = 4 : 13 % 15-19 -> 60-64
    ...
    ageInds = [toInd(allcomb(2 : 6 , 1 : viral , 1 : hpvTypes , 1 : hpvStates , 1 : periods , ...
        ...
        2 , a , 1 : risk))];
    cinPos2014(a - 3) = (sum(popVec((2006 - startYear) * stepsPerYear , cinInds)))...
        ./ sum(popVec((2006 - startYear) * stepsPerYear , ageInds)) * 100;
    ...
    ageNegInds = [toInd(allcomb(1 , 1 : viral , 1 : hpvTypes , 1 : hpvStates , 1 : periods , ...
        ...
        2 , a , 1 : risk))];
    cinNeg2014(a - 3) = (sum(popVec((2006 - startYear) * stepsPerYear , cinNegInds)))...
        ./ (sum(popVec((2006 - startYear) * stepsPerYear , ageNegInds))) * 100;
end
...
for aV = 1 : length(ageVec)
    ...
    ageInds = toInd(allcomb([2:6,10] , 1 : viral , 1 : hpvTypes , 1 : hpvStates , 1 : periods , ...
        1 , a , 1 : risk));
    hpv_hivM2008(aV) = hpv_hivM2008(aV) + sum(popVec((2009 - startYear) * stepsPerYear , hpvInds))...
        ./ sum(popVec((2009 - startYear) * stepsPerYear , ageInds)) * 100;
end
...
for aV = 1 : length(ageVec)
    ...
    for d = 1 : length(dVec)
        ...
        ageInds = toInd(allcomb(dVec(d) , 1 : viral , 1 : hpvTypes , 1 : hpvStates , 1 : periods , ...
            1 , a , 1 : risk));
        hpv_hivMNeg2008(aV) = hpv_hivMNeg2008(aV) + sum(popVec((2009 - startYear) * stepsPerYear , hpvInds))...
            ./ sum(popVec((2009 - startYear) * stepsPerYear , ageInds)) * 100;
    end
end
