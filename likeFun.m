...
%% CIN1, CIN2, CIN3 prevalence by HIV status
% HIV-positive (on and not on ART)
...
mObs = [mObs ; cin1Pos2015; cin2Pos2015; cin3Pos2015; cin1Neg2015; cin2Neg2015; cin3Neg2015];
dMean = [dMean ; cinPos2015_dObs(: , 2) ; cinNeg2015_dObs(: , 2)];
dVar = [dVar ; cinPos2015_dObs(: , 3) ; cinNeg2015_dObs(: , 3)];
