...
if (year >= 1995) && (year < 2000)
    ...
    partnersMmult(4) = partnersMmult(4) + d_partnersMmult(4) .* dt; %M+F, 30+
elseif year >= 2000
    partnersMmult(1) = 1.1;
    partnersMmult(2) = 1.3;
    partnersMmult(3) = 1.0;
...
partnersM(4, 1:3) = partnersM(4, 1:3) .* partnersMmult(1);
partnersF(4, 1:3) = partnersF(4, 1:3) .* partnersMmult(2);
partnersM(5:6, 1:3) = partnersM(5:6, 1:3) .* partnersMmult(3);
partnersF(5:6, 1:3) = partnersF(5:6, 1:3) .* partnersMmult(3);
partnersM(7:10, 1:3) = partnersM(7:10, 1:3) .* partnersMmult(3);
