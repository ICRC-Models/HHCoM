...
for j = 1 : nRuns
    ...
    for t = 1 : length(mortYearVec)
            ...
            deathIndsF_hivNeg = toInd(allcomb(1 : 2 , 1 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , 1 : intervens , 2 , 4 : 13 , 1 : risk));
            mortF_hivNeg(j , t) = (annlz(sum(sum(hivDeaths(mortTimeSpan , 1 : 2 , 2 , 4 : 13), 2), 4)) + ...
                annlz(sum(deaths(mortTimeSpan , deathIndsF_hivNeg), 2))) ...
            ...
            deathIndsF_hivPos = toInd(allcomb(3 : disease , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , 1 : intervens , 2 , 4 : 13 , 1 : risk));
            mortF_hivPos(j , t) = (annlz(sum(sum(hivDeaths(mortTimeSpan , 3 : disease , 2 , 4 : 13), 2), 4)) + ...
                annlz(sum(deaths(mortTimeSpan , deathIndsF_hivPos), 2))) ...
            ...
            deathIndsM_hivNeg = toInd(allcomb(1 : 2 , 1 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , 1 : intervens , 1 , 4 : 13 , 1 : risk));
            mortM_hivNeg(j , t) = (annlz(sum(sum(hivDeaths(mortTimeSpan , 1 : 2 , 1 , 4 : 13), 2), 4)) + ...
                annlz(sum(deaths(mortTimeSpan , deathIndsM_hivNeg), 2))) ...
            ...
            deathIndsM_hivPos = toInd(allcomb(3 : disease , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , 1 : intervens , 1 , 4 : 13 , 1 : risk));
            mortM_hivPos(j , t) = (annlz(sum(sum(hivDeaths(mortTimeSpan , 3 : disease , 1 , 4 : 13), 2), 4)) + ...
                annlz(sum(deaths(mortTimeSpan , deathIndsM_hivPos), 2))) ...
