...
hivInds = toInd(allcomb(3 : 7 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates, ...
    1 : endpoints , 1 : intervens , 1 : 2 , 16 : 50 , 1 : risk));
...
hivAge = zeros(length(tVec) , age/5);
...
% for g = 1 : gender
%     for a = 1 : age
%         hivAgeInds = [toInd(allcomb(2 : 6 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
%             g , a , 1 : risk)); toInd(allcomb(10 , 6 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
%             g , a , 1 : risk))];
...
for g = 1 : gender
    hivInds = [toInd(allcomb(3 : 7 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        1 : intervens , g , 16 : 50 , 1 : risk)); toInd(allcomb(8 , 6 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        1 : intervens , g , 16 : 50 , 1 : risk))];
...
figure()
artInds = toInd(allcomb(8 , 6 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , ...
    1 : endpoints , 1 : intervens , 1 : gender , 16 : 50 , 1 : risk));
artPop = sum(popVec(: , artInds) , 2);
hivInds = toInd(allcomb(3 : 7 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates, ...
    1 : endpoints , 1 : intervens , 1 : gender , 16 : 50 , 1 : risk));
hivPop = sum(popVec(: , hivInds) , 2);
...
for g = 1 : gender
    % General
    hpvInds = toInd(allcomb(1 : disease , 1 : viral , 2 : hpvVaxStates , 1 , ...
        1 : endpoints , g , 11 : age , 1 : risk));
    hpvPop = sum(popVec(: , hpvInds) , 2);
    popTot = popVec(: , toInd(allcomb(1 : disease , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        g , 11 : age , 1 : risk)));
    % HIV+
    hpvHivInds = toInd(allcomb(2 : 6 , 1 : viral , 2 : hpvVaxStates , 1 , ...
        1 : endpoints , g , 11 : age , 1 : risk));
    hpvHivPop = sum(popVec(: , hpvHivInds) , 2);
    popHivTot = popVec(: , toInd(allcomb(2 : 6 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        g , 11 : age , 1 : risk)));
    %ART
    hpvArtInds = toInd(allcomb(10, 6 , 2 : hpvVaxStates , 1 , ...
        1 : endpoints , g , 11 : age , 1 : risk));
    hpvArtPop = sum(popVec(: , hpvArtInds) , 2);
    popArtTot = popVec(: , toInd(allcomb(10 , 6 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        g , 11 : age , 1 : risk)));
    %HIV-
    hpvHivNegInds = toInd(allcomb([1,7:9] , 1 , 2 : hpvVaxStates , 1 , ...
        1 : endpoints , g , 11 : age , 1 : risk));
...
% for aInd = 1 : 13
%     a = aVec{aInd};
%     hpvInds = toInd(allcomb(1 : disease , 1 : viral , 2 : hpvVaxStates , 1 : 4, ...
%         1 : endpoints , 2 , a , 1 : risk));
%     ageInds = toInd(allcomb(1 : disease , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
%         2 , a , 1 : risk));
%     hpv2017(aInd) = sum(popVec((2002 - startYear) * stepsPerYear , hpvInds))...
%         ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
% 
%     % immune
%     hpvImmInds = toInd(allcomb(1 : disease , 1 : viral , 2 : hpvVaxStates , 10, ...
%         1 : endpoints , 2 , a , 1 : risk));
%     hpvImm2017(aInd) = sum(popVec((2002 - startYear) * stepsPerYear , hpvImmInds))...
%         ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
% end
% figure()
...
% xlabel('Age Group'); ylabel('Prevalence (%)')
% title('hrHPV Immunity Prevalence in 2002')

for aInd = 1 : 13
    a = aVec{aInd};
    hrInds = toInd(allcomb(1 : disease , 1 : viral , 2 : 5 , 1 , ...
        1 , 1 : intervens , 2 , a , 1 : risk));

    ageInds = toInd(allcomb(1 : disease , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        1 : intervens , 2 , a , 1 : risk));

    hpv2017(aInd,1) = (sum(popVec((2002 - startYear) * stepsPerYear , hrInds)))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
    
    % HIV+
    hrHIVInds = [toInd(allcomb(3 : 7 , 1 : viral , 2 : 5 , 1 , ...
        1 , 1 : intervens , 2 , a , 1 : risk)); toInd(allcomb(8 , 6 , 2 : 5 , 1 : hpvNonVaxStates , ...
        1 , 1 : intervens , 2 , a , 1 : risk));];

    ageHIVInds = [toInd(allcomb(3 : 7 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        1 : intervens , 2 , a , 1 : risk)); toInd(allcomb(8 , 6 , 1 : hpvVaxStates , 1 : hpvNonVaxStates, ...
        1 : endpoints , 1 : intervens , 2 , a , 1 : risk))];

    hpvHIV2017(aInd,1) = (sum(popVec((2002 - startYear) * stepsPerYear , hrHIVInds)))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageHIVInds)) * 100;
    
    % HIV-
    hrNegInds = toInd(allcomb(1 : 2 , 1 , 2 : 5 , 1 , ...
        1 , 1 : intervens , 2 , a , 1 : risk));

    ageNegInds = toInd(allcomb(1 : 2 , 1 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        1 : intervens , 2 , a , 1 : risk));

    hpvNeg2017(aInd,1) = (sum(popVec((2002 - startYear) * stepsPerYear , hrNegInds)))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageNegInds)) * 100;

    % immune
    hrImmInds = toInd(allcomb(1 : disease , 1 : viral , 7 , 1 , ...
        1 , 1 : intervens , 2 , a , 1 : risk));

    hpvImm2017(aInd,1) = (sum(popVec((2002 - startYear) * stepsPerYear , hrImmInds)))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
end
...
% cinPos2017 = zeros(hpvVaxStates - 1 , 13 , 1);
...
%         2 , a , 1 : risk));...
%         toInd(allcomb(10 , 6 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
%         2 , a , 1 : risk))];
%     cinPos2017(h - 1 , aInd) = (sum(popVec((2002 - startYear) * stepsPerYear , cinInds)))...
%         ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
% 
...
%         1 : endpoints , 2 , a , 1 : risk))];
%     ageNegInds = [toInd(allcomb(1 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
%         2 , a , 1 : risk)); ...
%         toInd(allcomb(7 : disease , 1 : 5 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
%         2 , a , 1 : risk))];
%     cinNeg2017(h - 1 , aInd) = (sum(popVec((2002 - startYear) * stepsPerYear , cinNegInds)))...
%         ./ (sum(popVec((2002 - startYear) * stepsPerYear , ageNegInds))) * 100;
%     end
% end
% 
...
% xlabel('Age Group'); ylabel('Prevalence (%)')
% title('Age Specific CIN2/3 Prevalence Among HIV+ in 2002')
% ylim([0 25])
% 
% cinNegAct(: , 1) = [0.016
% 0.027
...
for aInd = 1 : 13
    a = aVec{aInd};
    % HIV+
    cinInds = [toInd(allcomb(2 : 6 , 1 : viral , 2 : hpvVaxStates , 3 : 4, ...
        1 : endpoints , 2 , a , 1 : risk));toInd(allcomb(10 , 6 , 2 : hpvVaxStates , 3 : 4, ...
        1 : endpoints , 2 , a , 1 : risk))];
    ageInds = [toInd(allcomb(2 : 6 , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        2 , a , 1 : risk));toInd(allcomb(10 , 6 , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        2 , a , 1 : risk))];
    cinPos2017(aInd) = (sum(popVec((2002 - startYear) * stepsPerYear , cinInds)))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
    
    cinNegInds = toInd(allcomb([1,7:9], 1 : viral , 2 : hpvVaxStates , 3 : 4, ...
        1 : endpoints , 2 , a , 1 : risk));
    ageNegInds = toInd(allcomb([1,7:9] , 1 : viral , 1 : hpvVaxStates , 1 : hpvNonVaxStates , 1 : endpoints , ...
        2 , a , 1 : risk));
    cinNeg2017(aInd) = (sum(popVec((2002 - startYear) * stepsPerYear , cinNegInds)))...
        ./ (sum(popVec((2002 - startYear) * stepsPerYear , ageNegInds))) * 100;
end
...
% % HIV+
% ccHivInds = toInd(allcomb(2 : 6 , 1 : 5 , 2 : hpvVaxStates , 5 : 7, ...
%      1 : endpoints , 2 , 11:15 , 1 : risk));
% ccHivPop = sum(popVec(: , ccHivInds) , 2);
% popHivTot = popVec(: , toInd(allcomb(2 : 6 , 1 : 5 , 1 : hpvVaxStates , [1:8,10] ,  1 : endpoints , ...
%     2 , 11:15 , 1 : risk)));
% %ART
% ccArtInds = toInd(allcomb(10, 6 , 2 : hpvVaxStates , 5 : 7, ...
%      1 , 2 , 11:15 , 1 : risk));
% ccArtPop = sum(popVec(: , ccArtInds) , 2);
% popArtTot = popVec(: , toInd(allcomb(10 , 6 , 1 : hpvVaxStates , [1:8,10] ,  1 : endpoints , ...
%     2 , 11:15 , 1 : risk)));
% %HIV-
% ccHivNegInds = toInd(allcomb([1,7:9] , 1 , 2 : hpvVaxStates , 5 : 7, ...
%      1 , 2 , 11:15 , 1 : risk));
% ccHivNegPop = sum(popVec(: , ccHivNegInds) , 2);
% popHivNegTot = popVec(: , toInd(allcomb([1,7:9] , 1 , 1 : hpvVaxStates , [1:8,10] ,  1 : endpoints , ...
%     2 , 11:15 , 1 : risk)));
% 
% figure();
% % plot(tVec , 100 * hpvPop ./ sum(popTot , 2))
