...
%     'maleActs' , 'femaleActs' , 'riskDist' , 'mue' , 'mue2' , 'epsA_vec' , 'epsR_vec' , 'yr');
% load([paramDir, 'hivParams'], 'betaHIVM2F' , 'betaHIVF2M' , 'muHIV' , 'kCD4');
...
%     'maxRateM' , 'maxRateF' , 'hivStartYear' , 'circStartYear' , ...
...
[stepsPerYear , timeStep , startYear , currYear , endYear , ...
    ...
    deathMat , deathMat2 , circMat , circMat2] = loadUp2(1 , 0 , [] , [] , []);
...
legend('Model' , 'Observed SA: World Bank, World Dev Indicators' , ...
...
for a = 1 : age
    ...
    for y = 1 : length(ccIncYears)
        ...
        % Total population
        ageInds = toInd(allcomb(1 : disease , 1 : viral , [1 : 5 , 7] , [1 : 5 , 7] , 1 : endpoints , ...
        ...
        % Total by age
        ageTotal = annlz(sum(popVec(yr_start : yr_end , ...
            toInd(allcomb(1 : disease , 1 : viral , [1 : 5 , 7] , [1 : 5 , 7] , 1 , ...
            1 : intervens , 2 , a , 1 : risk))), 2 )) ./ stepsPerYear;
...
%         'CD4 < 200' , 'ART' , 'Location' , 'NorthWest')
    hold on
    % globocan data
    plot(4 : age , globocan_ub , 'r--' , 4 : age , globocan_lb , 'r--') %4 : age , globocan , '-' , 
