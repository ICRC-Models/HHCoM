...
for a = 4 : age
    ...
    ageInds = toInd(allcomb(1 : disease , 1 : viral , 1 : hpvTypes , 1 : hpvStates , 1 : periods , ...
        2 , a , 1 : risk));
    hpv2017(a - 3) = sum(popVec((2002 - startYear) * stepsPerYear , hpvInds))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;

    % immune
    hpvImmInds = toInd(allcomb(1 : disease , 1 : viral , 2 : 4 , 10, ...
        1 : periods , 2 , a , 1 : risk));
    hpvImm2017(a - 3) = sum(popVec((2002 - startYear) * stepsPerYear , hpvImmInds))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
end
figure()
...
for a = 4 : age
    ...
    hpvImm2017(a - 3) = (sum(popVec((2002 - startYear) * stepsPerYear , hrImmInds)))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
end
...
for a = 4 : age
    ...
    ageInds = [toInd(allcomb(2 : 6 , 1 : viral , 1 : hpvTypes , 1 : hpvStates , 1 : periods , ...
        ...
        2 , a , 1 : risk))];
    cinPos2017(h - 1 , a - 3) = (sum(popVec((2002 - startYear) * stepsPerYear , cinInds)))...
        ./ sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) * 100;
    ...
    ageNegInds = [toInd(allcomb(1 , 1 : viral , 1 : hpvTypes , 1 : hpvStates , 1 : periods , ...
        ...
        2 , a , 1 : risk))];
    cinNeg2017(h - 1 , a - 3) = (sum(popVec((2002 - startYear) * stepsPerYear , cinNegInds)))...
        ./ (sum(popVec((2002 - startYear) * stepsPerYear , ageNegInds))) * 100;
    end
end
...
for a = 4 : age
    for cin = 3 : 5
        ...
        ageArtInds = toInd(allcomb(10 , 6 , 1 : hpvTypes , cin - 1 , 1 : periods , ...
            2 , a , 1 : risk));
        cinHiv2017(cin - 2) = (sum(popVec((2002 - startYear) * stepsPerYear , cinInds)) + sum(popVec((2002 - startYear) * stepsPerYear , cinArtInds)))...
            ./ (sum(popVec((2002 - startYear) * stepsPerYear , ageInds)) + sum(popVec((2002 - startYear) * stepsPerYear , ageArtInds)))* 100;
    end
end
...
%% Incidence
ccIncYears = [2003 , 1994 , 2012]; %2017
