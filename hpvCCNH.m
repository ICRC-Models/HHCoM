...
for d = 1 : disease
    ...
    if d > 3 && d < 8
        ...
        c3c2Mult = c3c2Mults(d - 3) .* .8; % CIN2 -> CIN3 progression multiplier
        ...
        c2c3Mult = hpv_hivClear(d - 3).* 1.5; % CIN3 -> CIN2 regression multiplier
    ...
    elseif d == 8
        ...
        c3c2Mult = c3c2Mults(1) .* .8; % CIN2 -> CIN3 progression multiplier
