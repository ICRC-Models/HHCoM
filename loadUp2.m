...
% mue(: , 1) = xlsread(file , 'Demographics' , 'B84:B99'); %'AX84:AX99'); % 1950
% mue(: , 2) = xlsread(file , 'Demographics' , 'O84:O99'); %'BE84:BE99');
% mue2 = zeros(age , gender);
% mue2(: , 1) = xlsread(file , 'Demographics' , 'I84:I99'); %'AY84:AY99'); % 1985
% mue2(: , 2) = xlsread(file , 'Demographics' , 'V84:V99'); %'BF84:BF99');
% mue3 = zeros(age , gender);
% mue3(: , 1) = xlsread(file , 'Demographics' , 'J84:J99'); %'AZ84:AZ99'); % 2000
% mue3(: , 2) = xlsread(file , 'Demographics' , 'W84:W99'); %'BG84:BG99');
% mue4 = zeros(age , gender);
% mue4(: , 1) = xlsread(file , 'Demographics' , 'L84:L99'); %'BB84:BB99'); % 2020
% mue4(: , 2) = xlsread(file , 'Demographics' , 'Y84:Y99'); %'BI84:BI99');
