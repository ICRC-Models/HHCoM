...
if calibBool && any(8 == pIdx)
    ...
    maleActs(5, 1:risk) = maleActs(5, 1:risk).* 1.8 ;
...
d_partnersMmult(2) = (1.1 - partnersMmult(2)) ./ ((2000 - 1995) * stepsPerYear);
d_partnersMmult(3) = (0.85 - partnersMmult(3)) ./ ((2000 - 1995) * stepsPerYear);
