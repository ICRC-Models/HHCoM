...
% ART coverage
artOutMult = 1.0; %0.95;
maxRateM = [0.15*artOutMult , 0.26*artOutMult , 0.55*artOutMult , 0.729*artOutMult]; % population-level ART coverage in males
maxRateF = [0.20*artOutMult , 0.35*artOutMult , 0.70*artOutMult , 0.729*artOutMult]; % population-level ART coverage in females
