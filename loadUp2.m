...
maxRateM = [artVScov((1:end-1),3) ; 0.508333 ; 0.508333] .* artOutMult; % population-level ART coverage in males
maxRateF = [artVScov((1:end-1),2) ; 0.627829 ; 0.627829] .* artOutMult; % population-level ART coverage in females
