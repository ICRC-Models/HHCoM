...
% mue(: , 1) = xlsread(file , 'Demographics' , 'B84:B99'); % 1950
% mue(: , 2) = xlsread(file , 'Demographics' , 'O84:O99');
% mue2 = zeros(age , gender);
% mue2(: , 1) = xlsread(file , 'Demographics' , 'I84:I99'); % 1985
% mue2(: , 2) = xlsread(file , 'Demographics' , 'V84:V99');
