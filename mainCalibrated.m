...
%function [negSumLogL] = mainCalibrated(pIdx , paramsSub , paramSet)
...
pathModifier = 'toNow_102019_5yrAgeGrps_noBaseVax_baseScreen_nonVhpv'; % ***SET ME***: name for historical run output file 
