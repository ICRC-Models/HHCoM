...
pathModifier = 'toNow_082119_singleAge_baseScreen_noBaseVax_2020'; % ***SET ME***: name for historical run output file 
    ...
    if hpvOn
        ...
        if (year >= hpvScreenStartYear)
            [dPop , newScreen(i , : , : , : , : , : , : , :) , ...
                ...
                newTreatHpv(i , : , : , : , : , : , : , :) , ...
                newTreatHyst(i , : , : , : , : , : , : , :)] ...
                = hpvScreen(popIn , disease , viral , hpvTypes , hpvStates , age , risk , ...
