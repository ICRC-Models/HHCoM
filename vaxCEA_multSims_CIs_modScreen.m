...
screenTotAnnualCum = zeros(nRuns , 5 , 6 , length(futAnnualTimespan));
...
for k = 1 : loopSegmentsLength-1
    ...
    %     noV = vaxResult{noVaxInd};
        ...
        %% Total number of women screened in states >=CIN2 annually (1 = CIN2:9v+, 2 = CIN2:9v-, 3 = CIN3:9v+, 4 = CIN3:9v-, 5 = CC:9v+, 6 = CC:9v-) by HIV disease status
        for dInd = 1 : diseaseVecLength_ccInc
            d = diseaseVec_ccInc{dInd};
            screenTotAnnualCum(j , dInd , : , :) = [(annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , 4 , [1:4 , 7] , 1 , : , :),2),3),4),5),6),7)) + annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , [2:3] , 4 , 1 , : , :),2),3),4),5),6),7))); ...
                annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , [1 , 7] , 4 , 1 , : , :),2),3),4),5),6),7)) ; ...
                (annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , 5 , [1:5 , 7] , 1 , : , :),2),3),4),5),6),7)) + annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , [2:4] , 5 , 1 , : , :),2),3),4),5),6),7))); ...
                annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , [1 , 7] , 5 , 1 , : , :),2),3),4),5),6),7)); ...
                (annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , 6 , [1:6 , 7] , 1:3 , : , :),2),3),4),5),6),7)) + annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , [2:5] , 6 , 1:3 , : , :),2),3),4),5),6),7))); ...
                annlz(sum(sum(sum(sum(sum(sum(vaxResult{n}.newScreen(: , d , [1 , 7] , 6 , 1:3 , : , :),2),3),4),5),6),7))];
        end    
...
if contains(baseFileName , 'CISNET')
...
if contains(baseFileName , 'SA')
    ...
    for dInd = 1 : length(diseaseLabels)
        ...
        writematrix([[squeeze(median(cumsum(squeeze(screenTotAnnualCum(: , dInd , 1 , :)),2) , 1))' , ...
                ...
                cumsum(squeeze(screenTotAnnualCum(: , dInd , 1 , :)),2)'] ; ...
            [squeeze(median(cumsum(squeeze(screenTotAnnualCum(: , dInd , 2 , :)),2) , 1))' , ...
                squeeze(min(cumsum(squeeze(screenTotAnnualCum(: , dInd , 2 , :)),2) , [] , 1))' , ...
                squeeze(max(cumsum(squeeze(screenTotAnnualCum(: , dInd , 2 , :)),2) , [] , 1))' , ...
                cumsum(squeeze(screenTotAnnualCum(: , dInd , 2 , :)),2)'] ; ...
            [squeeze(median(cumsum(squeeze(screenTotAnnualCum(: , dInd , 3 , :)),2) , 1))' , ...
                squeeze(min(cumsum(squeeze(screenTotAnnualCum(: , dInd , 3 , :)),2) , [] , 1))' , ...
                squeeze(max(cumsum(squeeze(screenTotAnnualCum(: , dInd , 3 , :)),2) , [] , 1))' , ...
                cumsum(squeeze(screenTotAnnualCum(: , dInd , 3 , :)),2)'] ; ...
            [squeeze(median(cumsum(squeeze(screenTotAnnualCum(: , dInd , 4 , :)),2) , 1))' , ...
                squeeze(min(cumsum(squeeze(screenTotAnnualCum(: , dInd , 4 , :)),2) , [] , 1))' , ...
                squeeze(max(cumsum(squeeze(screenTotAnnualCum(: , dInd , 4 , :)),2) , [] , 1))' , ...
                cumsum(squeeze(screenTotAnnualCum(: , dInd , 4 , :)),2)'] ; ...
            [squeeze(median(cumsum(squeeze(screenTotAnnualCum(: , dInd , 5 , :)),2) , 1))' , ...
                squeeze(min(cumsum(squeeze(screenTotAnnualCum(: , dInd , 5 , :)),2) , [] , 1))' , ...
                squeeze(max(cumsum(squeeze(screenTotAnnualCum(: , dInd , 5 , :)),2) , [] , 1))' , ...
                cumsum(squeeze(screenTotAnnualCum(: , dInd , 5 , :)),2)'] ; ...
            [squeeze(median(cumsum(squeeze(screenTotAnnualCum(: , dInd , 6 , :)),2) , 1))' , ...
                squeeze(min(cumsum(squeeze(screenTotAnnualCum(: , dInd , 6 , :)),2) , [] , 1))' , ...
                squeeze(max(cumsum(squeeze(screenTotAnnualCum(: , dInd , 6 , :)),2) , [] , 1))' , ...
                cumsum(squeeze(screenTotAnnualCum(: , dInd , 6 , :)),2)']] , ...
            fname , 'Sheet' , diseaseLabels{dInd} , 'Range' , 'C3')   
    end
end
