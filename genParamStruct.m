...
paramsAll{3}.name = 'riskDistM'; paramsAll{3}.length = 39; ...
...
paramsAll{4}.name = 'riskDistF'; paramsAll{4}.length = 39; ...
...
paramsAll{8}.name = 'maleActs'; paramsAll{8}.length = 1; ... %42; 
    ...
    paramsAll{8}.ub = ones(paramsAll{8}.length,1).*5.0; %[ones(paramsAll{8}.length*(1/3),1).*90.0; ones(paramsAll{8}.length*(1/3),1).*0.99; ...
...
paramsAll{9}.name = 'femaleActs'; paramsAll{9}.length = 1; ... %42; ...
    ...
    paramsAll{9}.ub = ones(paramsAll{9}.length,1).*5.0; %[ones(paramsAll{9}.length*(1/3),1).*90.0; ones(paramsAll{9}.length*(1/3),1).*0.99; ...
...
% kCC_Cin3, [age x 1]
paramsAll{25}.name = 'kCC_Cin3'; paramsAll{25}.length = 1; ...
    paramsAll{25}.lb = ones(paramsAll{25}.length,1).*0.2; ...
    paramsAll{25}.ub = ones(paramsAll{25}.length,1).*5.0;
