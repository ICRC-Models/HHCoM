        ...
        for rr = 1 : risk
            if popSum(1 , a , r) ~= 0
                for v = 1 : 5 % viral load (up to vl = 6). Note: last index is (viral - 1) + 1. Done to align pop index with betaHIV index.
                    beta(1 , a , aa , r , rr) = beta(1 , a , aa , r , rr) - log(1 - betaHIVM2F(a , rr , v)) ...
                      * sumall(pop(mCurr(a , r , v , :))) ./ popSum(1 , a , r);
                end
                beta(1 , a , aa , r , rr) = beta(1 , a , aa , r , rr) - log(1 - betaHIVM2F(a , rr , 6)) ...
                * sumall(pop(mCurrArt(a , r , 1 , :)))  ./ popSum(1 , a , r);
            end
            if popSum(2 , a , r) ~= 0
                for v = 1 : 5 % viral load (up to vl = 6). Note: last index is (viral - 1) + 1. Done to align pop index with betaHIV index.
                    beta(2 , a , aa , r , rr) = beta(2 , a , aa , r , rr) - log(1 - betaHIVF2M(a , rr , v))...
                      * sumall(pop(fCurr(a , r , v , :))) ./ popSum(2 , a , r);
                end
                beta(2 , a , aa , r , rr) = beta(2 , a , aa , r , rr) - log(1 -   betaHIVF2M(a , rr , 6))...
