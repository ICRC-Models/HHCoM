...
%% Load hand-calibrated parameter values
% handCalib = [0.80; 12.2; 25.0; 25.0; 12.0; 0.22; 0.50; ...    % 22Apr20 Phase 1
%              9.0; 26.0; 19.0; 14.0; 10.0; 0.58; 0.30; ...
%              0.25; 0.4921; ...
%              70.844; 69.954; 56.2; 54.6; 52.7; ...
%              0.01; 0.57479; 2.60; 1.41; ...
%              0.000575; 3.5];
handCalib = [0.80; 12.2; 25.0; 25.0; 12.0; 0.22; 0.50; ...    % 22Apr20 Phase 1 + Phase 2
             9.0; 26.0; 19.0; 14.0; 10.0; 0.58; 0.30; ...
             0.25; 0.4921; ...
             70.844; 69.954; 56.2; 54.6; 52.7; ...
             0.000575; ...
             0.01; 1.0; 1.0; 0.57479; ...
             0.80; 2.00; 1.40; 2.00; 1.30; 2.00; 1.00; 5.00; 2.60; 1.41; 1.80; 0.97; 1.40; 0.20; 1.00; 0.20; ...
             3.5; 1.0; 1.0];
...
%     p1.Color(4) = 1.0;
    ...
    if  i == size(top50Params,1) %idx == size(tempIdx,2)
        ...
        legend(['t' , num2str(tstep_abc) , ' ksdensity'] , 'Hand-calibrated value');
    end
end
