...
function[stepsPerYear , timeStep , startYear , currYear , endYear , ... 
    ...
    ccReghpvVaxInds_treat , ccDisthpvVaxInds_treat , vaxEff , vaxEffItt] = loadUp2_IttEff(fivYrAgeGrpsOn , calibBool , pIdx , paramsSub , paramSet , paramSetIdx)
...
hpvVaxImm = hpvVaxSus;
hpvVaxInf = hpvVaxSus;
% hpvVaxIttSus = hpvVaxSus; 
% hpvVaxIttImm = hpvVaxSus; 
% hpvVaxIttInf = hpvVaxSus; 
        ...
        for a = 1 : age
            for r = 1 : risk
                for p = 1 : intervens
                    ...
                    % hpvVaxIttSus(d , g , a , r , p , :) = ...
                    %     sort(toInd(allcomb(d , 1 : viral , 8 , 1 : hpvNonVaxStates , 1 : 9 , p , g , a , r)));
                    % hpvVaxIttImm(d , g , a , r , p , :) = ...
                    %     sort(toInd(allcomb(d , 1 : viral , 9 , 1 : hpvNonVaxStates , 1 : 9 , p , g , a , r)));
                    % hpvVaxIttInf(d , g , a , r , p , :) = ...
                    %     sort(toInd(allcomb(d , 1 : viral , 10 , 1 : hpvNonVaxStates , 1 : 9 , p , g , a , r)));
...
% normalhpvVaxIttInds = normalhpvVaxInds; 
% immunehpvVaxInds = normalhpvVaxInds;
% immunehpvVaxIttInds = normalhpvVaxInds; 
infhpvVaxInds = normalhpvVaxInds;
% infhpvVaxIttInds = normalhpvVaxInds; 
...
for g = 1 : gender
    for d = 1 : disease
        for a = 1 : age
                ...
                % normalhpvVaxIttInds(d , g, a, :) = ... %susceptible but hpv+ at time of vax
                %     sort(toInd(allcomb(d , 1 : viral , 8 , 1 : hpvNonVaxStates , 1 : 9 , 1 : intervens , g , a , 1 : risk))); 
                ...
                % immunehpvVaxIttInds(d , g , a , :) = ...
                %     sort(toInd(allcomb(d , 1 : viral , 9 , 1 : hpvNonVaxStates , 1 : 9 , 1 : intervens , g , a , 1 : risk))); 
                ...
                % infhpvVaxIttInds(d , g , a , :) = ...
                %     sort(toInd(allcomb(d , 1 : viral , 10 , 1 : hpvNonVaxStates , 1 : 9 , 1 : intervens , g , a , 1: risk))); 
