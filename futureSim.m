...
% LOAD POPULATION
historicalIn = load([pwd , '/HHCoM_Results/toNow_24Feb20_noBaseVax_baseScreen_hpvHIVcalib_0_1_mod7867-45incInitPop3-fixImmMult-clearAgeDist12-decFacts6-decMacts1-decCIN2reg-incCINprog-delta-incCircScaleUp_033120']); % ***SET ME***: name for historical run input file 

% DIRECTORY TO SAVE RESULTS
pathModifier = '24Feb20_noBaseVax_baseScreen_hpvHIVcalib_0_1_mod7867-45incInitPop3-decFacts6---incCINprog-delta-incCircScaleUp_033120_WHOP1_SCES012-test'; % ***SET ME***: name for simulation output file
% Directory to save results
