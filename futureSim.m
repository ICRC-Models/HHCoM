...
% LOAD POPULATION
historicalIn = load([pwd , '/HHCoM_Results/toNow_101819_5yrAgeGrps_noBaseVax_baseScreen_nonVhpv']); % ***SET ME***: name for historical run input file 
...
[stepsPerYear , timeStep , startYear , currYear , endYear , ...
    ...
    hivFertPosBirth2 , hivFertNegBirth2 , deathMat , circMat , circMat2] = loadUp2(fivYrAgeGrpsOn , 0 , [] , [] , []);
