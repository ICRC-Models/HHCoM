...
function futureSim_Kenya(calibBool , pIdx , paramsSub , paramSet , paramSetIdx , tstep_abc , date) 
%%
...
% LOAD POPULATION
historicalIn = load([pwd , '/HHCoM_Results/toNow_30May20_K_increaseClearHIV_increasekCC_5_muART_final']); % ***SET ME***: name for historical run input file 

% DIRECTORY TO SAVE RESULTS
pathModifier = '3Jun20_80VaxCov_muART_Kenya'; % ***SET ME***: name for simulation output file
% Directory to save results
...
parfor n = 1 : nTests
    ...
    for i = 2 : length(s) - 1
        ...
        ode4xtra(@(t , pop) mixInfect_Kenya(t , pop , ...
        ...
        [~ , pop , deaths(i , :)] = ode4xtra(@(t , pop) ...
            bornAgeDieRisk_Kenya(t , pop , year , ...
