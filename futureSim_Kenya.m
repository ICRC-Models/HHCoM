...
% LOAD POPULATION
historicalIn = load([pwd , '/HHCoM_Results/toNow_30May20_K_increaseClearHIV_increasekCC_5']); % ***SET ME***: name for historical run input file 

% DIRECTORY TO SAVE RESULTS
pathModifier = '28May20_Kenya_80VaxCov'; % ***SET ME***: name for simulation output file
% Directory to save results
